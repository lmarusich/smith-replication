...
## In the Appendix, we present a *Conventional* Analysis which 
## drops the time-outs. 
...
write.csv(accModelTS$anova_table, "results/exp2_ANOVA_acc.csv")
accModelTS
...
merged.VS.data.convention <- merged.VS.data %>% filter(rt < 1500)
write.csv(merged.VS.data.convention, 
