...
## *Unconventional* Analysis: Time-Outs (>=1500 ms to respond) are treated as
## errors. The primary results are reported using this atypical approach to be 
## to be consistent with the original paper by Smith et al.

## Below, we present a *Conventional* Analysis which drops the time-outs for
## Percent Error (PE) results 
