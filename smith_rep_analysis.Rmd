...
acc_plot <-
 ...
 theme(axis.text=element_text(size=14),
  ...
  scale_shape_manual(name = "Posture",
                     values = c(15,16),
                     labels = c("Sitting", "Standing")) +
  labs(y = "Percent Error")

acc_plot$mapping[c(6)][[1]] <- as.name("Posture")
names(acc_plot$mapping)[6] <- "shape"
...
trimmed_RT_plot$mapping[c(6)][[1]] <- as.name("Posture")
names(trimmed_RT_plot$mapping)[6] <- "shape"
...
e2.accModel.conv <- aov_ez(data = e2.conv.PE, 
                      dv = "meanPE", 
                      id = "participant", 
                      within = c("posture", "congruentTrialType", "switchTrialType"), 
                      type = 3, 
...
write.csv(e2.accModel.conv$anova_table, "results/exp2_ANOVA_PE_con.csv")


#...CALCULATE THE BAYES FACTORS FOR THE ACC ANALYSIS
tsBF.conv = data.frame(e2.conv.PE)

bfValues2 = anovaBF(meanPE~ posture*switchTrialType+participant,
                   data = tsBF.conv,
                   whichRandom = "participant", 
                   method="laplace")
bfValues2
